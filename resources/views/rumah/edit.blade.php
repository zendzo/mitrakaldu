          ...
          <div class="box-body">
            <form class="form-horizontal"  action="{{ route('admin.rumah.update',$rumah->id) }}" method="POST">
              ...
              <div class="form-group{{ $errors->has('block') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                  <input id="block" name="block" type="text" class="form-control" placeholder="Block" value="{{ $rumah->block }}">
              ...
              <div class="form-group{{ $errors->has('no') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                  <input id="no" name="no" type="text" class="form-control" placeholder="No Rumah" value="{{ $rumah->no }}">
              ...
              <div class="form-group{{ $errors->has('harga') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                  <input id="harga" name="harga" type="text" class="form-control" placeholder="Harga" value="{{ $rumah->harga }}">
